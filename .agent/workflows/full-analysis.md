...
|------|------|----------|
| 股價 | $XX.XX | 現在買一股要多少錢 |
| 市值 | $X.XB | 這間公司值多少錢 (大公司較穩) |
| 數據時間 | YYYY-MM-DD | 這是什麼時候的資料 |
| 優先級 | 🟢/🟡/🔴 | 亮綠燈代表現在很熱門 |
| 評分 | XX/100 | 分數越高潛力越大 |
| 最近大事 | [日期] [事件] | 最近要注意的這個日子 |
| 建議買進價 | $XX.XX | 低於這個價格買比較安心 |
| 風險防線 | $XX.XX (-XX%) | 跌到這就要考慮認賠賣掉 |
| 目標價 | $XX.XX (+XX%) | 如果順利，預期可以漲到這 |
| 賺賠比 | X.X:1 | 代表每賠 1 元有機會賺 X 元 |
